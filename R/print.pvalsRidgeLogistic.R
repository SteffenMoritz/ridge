## print method for pvalsRidgeLogistic objects

#' @rdname print
#' @export
#' @importFrom stats printCoefmat
print.pvalsRidgeLogistic <- function(x, digits = max(3, getOption("digits") - 3), signif.stars = getOption("show.signif.stars"), all.coef = FALSE, ...)
  {
